class GameLevel {
    ...
    loadLevel() {
        ...
        this.level.game.load.audio('enemy_dying', 'benchmark3/assets/sounds/enemy_dying.ogg');
        this.level.game.load.audio('player_hit', 'benchmark3/assets/sounds/player_hit.ogg');
        this.level.game.load.audio('item_collect', 'benchmark3/assets/sounds/item_collect.ogg');
        this.level.game.load.audio('item_dropoff', 'benchmark3/assets/sounds/item_dropoff.ogg');
        this.level.game.load.audio('advance_level', 'benchmark3/assets/sounds/advance_level.ogg');
        this.level.game.load.audio('player_dying', 'benchmark3/assets/sounds/player_dying.ogg');
